  ...
  data: () => ({
      channels:[],
        ...
        menuprueba:{
            'Dashboard': 
            [
                ['Dashboard General', 'web_asset','trending_up'],
                ['Dashboard Eventos', 'web_asset','trending_up'],
                ['Dashboard Souvenirs', '','trending_up'],
                ['Dashboard Convenios', '','trending_up'],
                ['Dashboard COVID-19', '','trending_up'],
                ['Dashboard Aplicación Movil', '','trending_up'],
            ],
            'Gestión de eventos':
            [
                ['Eventos', 'flight','add'],
                ...
                ['Notificaciones de Eventos', '','event_available'],
                ['Actividades', '','post_add'],
                ['pruebaxd', '','post_add'],
            ],
            'UNIFRANZ TV':
            [
            ...
            'Gestión de Talleres':
            [
                ['Talleres', 'bug_report','post_add'],
                ['Notificaciónes de talleres', '',''],
            ],
            'Reportes':
            [
                ['Eventos', 'description',''],
        ...
        menu(title){
            for (let i = 0; i < this.channels.length; i++) {
                if(this.channels[i]==title){
                    return this.$router.push("/channelAdmin/"+title);
                }
            }
            ...
            if (title==='pruebaxd'){return this.$router.push('pruebaxd')}
            ...
            if (title==='Souvenirs'){return this.$router.push('inventory')}
             if (title==='Kardex'){return this.$router.push('kardex')}
            if (title==='Ajustes'){return this.$router.push('setting')}
